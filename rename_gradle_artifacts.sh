...
while getopts "pdvsqrtcfgl:" flag; do
  if [ "${flag}" = "l" ]; then
    ...
    declare -a gorm_mappings=(
      ...
      "org[.]grails:tck-tests|org.apache.grails.data:grails-datamapping-tck-tests"
      "org[.]grails:tck-domains|org.apache.grails.data:grails-datamapping-tck-domains"
      "org[.]grails:tck-base|org.apache.grails.data:grails-datamapping-tck-base"
      ...
      "org[.]grails:grails-datastore-gorm-mongodb-ext|org.apache.grails.data:grails-datamapping-mongodb-ext"
      "org[.]grails:grails-datastore-gorm-mongodb|org.apache.grails.data:grails-datamapping-mongodb"
      "org[.]grails:grails-datastore-gorm-hibernate6|org.apache.grails.data:grails-datamapping-hibernate6"
      "org[.]grails:grails-datastore-gorm-hibernate5|org.apache.grails.data:grails-datamapping-hibernate5"
    ...
    declare -a excluded_gorm_mappings=(
      ...
      "exclude[[:space:]]+module[[:space:]]*:[[:space:]]*['\"]grails-datastore-gorm-mongodb['\"]|exclude module:'grails-datamapping-mongodb'"
      "exclude[[:space:]]+module[[:space:]]*:[[:space:]]*['\"]grails-datastore-gorm-mongodb-ext['\"]|exclude module:'grails-datamapping-mongodb-ext'"
      "exclude[[:space:]]+module[[:space:]]*:[[:space:]]*['\"]grails-datastore-gorm-hibernate6['\"]|exclude module:'grails-datamapping-hibernate6'"
      "exclude[[:space:]]+module[[:space:]]*:[[:space:]]*['\"]grails-datastore-gorm-hibernate5['\"]|exclude module:'grails-datamapping-hibernate5'"
