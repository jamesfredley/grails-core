...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def projectBeta = new Project(name: 'Project Beta', code: 'BETA', startDate: new Date() - 30, active: true).save(failOnError: true)
        def projectGamma = new Project(name: 'Project Gamma', code: 'GAMMA', startDate: new Date() - 60, active: false).save(failOnError: true)
