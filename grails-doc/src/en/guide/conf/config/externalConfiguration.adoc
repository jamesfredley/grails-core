...
In the event that you need to debug external configuration, you can set the logging category `org.grails.config.external.ExternalConfig` to `DEBUG` in your logback.xml.
