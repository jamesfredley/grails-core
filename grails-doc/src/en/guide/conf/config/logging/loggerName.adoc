...
`BookController.groovy` located at `grails-app/controllers/com/company` NOT annotated with `{groovyapi}groovy/util/logging/Slf4j.html[@Slf4j]`
...
`BookController.groovy` located at `grails-app/controllers/com/company` annotated with `{groovyapi}groovy/util/logging/Slf4j.html[@Slf4j]`
...
`BookService.groovy` located at `grails-app/services/com/company` NOT annotated with `{groovyapi}groovy/util/logging/Slf4j.html[@Slf4j]`
...
`BookService.groovy` located at `grails-app/services/com/company` annotated with `{groovyapi}groovy/util/logging/Slf4j.html[@Slf4j]`
...
`BookDetail.groovy` located at `src/main/groovy/com/company` annotated with `{groovyapi}groovy/util/logging/Slf4j.html[@Slf4j]`
