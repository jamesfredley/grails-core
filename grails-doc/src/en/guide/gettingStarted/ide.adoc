...
The new Apache Grails Maven Coordinates will be supported in IntelliJ IDEA 2025.2 and later releases via the https://plugins.jetbrains.com/plugin/18504-grails[Grails Plugin].  Prior to the release of 2025.2, you can use 2025.2 Beta.  
