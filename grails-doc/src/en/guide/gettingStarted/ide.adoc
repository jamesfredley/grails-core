...
The new Apache Grails Maven Coordinates are supported in IntelliJ IDEA 2025.2 and later releases via the https://plugins.jetbrains.com/plugin/18504-grails[Grails Plugin]. 
