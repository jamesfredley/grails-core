...
[source,groovy]
----
include::{functionalSourceDir}/demo33/grails-app/controllers/demo/TestInterceptor.groovy[tags=declaration,indent=0]
----
...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/TestInterceptorSpec.groovy[tags=with_request,indent=0]
----
...
----
include::{functionalSourceDir}/demo33/grails-app/controllers/demo/TestController.groovy[tags=render_attribute,indent=0]
----
...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/TestInterceptorSpec.groovy[tags=with_interceptors,indent=0]
----
