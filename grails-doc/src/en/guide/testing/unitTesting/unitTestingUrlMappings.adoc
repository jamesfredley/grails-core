...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=setup,indent=0]
----
...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=forward,indent=0]
----
...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=reverse,indent=0]
----
...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=combined,indent=0]
----
...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=httpMethodsReverse,indent=0]
----
...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=httpMethodsForward,indent=0]
----
...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=httpMethodsCombined,indent=0]
----
...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=controller,indent=0]
----
...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=action,indent=0]
----
...
[source,groovy]
----
include::{functionalSourceDir}/demo33/src/test/groovy/demo/UrlMappingsSpec.groovy[tags=view,indent=0]
----