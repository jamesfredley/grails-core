...
For detailed information on how to upgrade to Grails 7, including major dependency changes, please see the xref:../upgrading/upgrading60x.adoc[Upgrading from Grails 6 to Grails 7] section.
