...
The key elements are the xref:../../../ref/Tags%20-%20GSP/layoutHead.adoc[layoutHead], xref:../../../ref/Tags%20-%20GSP/layoutTitle.adoc[layoutTitle] and xref:../../../ref/Tags%20-%20GSP/layoutBody.adoc[layoutBody] tag invocations:

* `layoutTitle` - outputs the target page's title
* `layoutHead` - outputs the target page's head tag contents
* `layoutBody` - outputs the target page's body tag contents

The previous example also demonstrates the xref:../../../ref/Tags%20-%20GSP/pageProperty.adoc[pageProperty] tag which can be used to inspect and return aspects of the target page.
...
While the xref:../../../ref/Tags%20-%20GSP/applyLayout.adoc[applyLayout] tag is useful for applying layouts to external content, if you simply want to include external content in the current page you use the xref:../../../ref/Tags%20-%20GSP/include.adoc[include] tag:
...
You can even combine the xref:../../../ref/Tags%20-%20GSP/include.adoc[include] tag and the xref:../../../ref/Tags%20-%20GSP/applyLayout.adoc[applyLayout] tag for added flexibility:
...
Finally, you can also call the xref:../../../ref/Tags%20-%20GSP/include.adoc[include] tag from a controller or tag library as a method:
...
The resulting content will be provided via the return value of the xref:../../../ref/Tags%20-%20GSP/include.adoc[include] tag.
