...
GSPs live in the `grails-app/views` directory and are typically rendered automatically (by convention) or with the xref:../../ref/Controllers/render.adoc[render] method such as:
