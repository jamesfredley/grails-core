...
The `JsonViewTemplate` superclass implements the link:{api}/grails/plugin/json/view/api/JsonView.html[JsonView] trait which in turn extends the the link:groovydoc/grails/views/api/GrailsView.html[GrailsView] trait.
