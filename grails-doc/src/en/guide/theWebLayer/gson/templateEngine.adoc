...
This class is a regular Groovy {groovydocumentation}template-engines.html[TemplateEngine], and you can use the engine to render JSON views outside the scope of an HTTP request.
