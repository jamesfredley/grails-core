...
Additionally, you can read a message inside Controllers and Tag Libraries with the link:../ref/Tags%20-%20GSP/message.html[Message Tag]. However, using the message tag relies on GSP support which a Grails application may not necessarily have; e.g. a rest application.
