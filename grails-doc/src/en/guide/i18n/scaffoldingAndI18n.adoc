...
Grails link:scaffolding.html[scaffolding] templates for controllers and views are fully i18n-aware. The GSPs use the link:{gspTagsRef}message.html[message] tag for labels, buttons etc. and controller `flash` messages use i18n to resolve locale-specific messages.
