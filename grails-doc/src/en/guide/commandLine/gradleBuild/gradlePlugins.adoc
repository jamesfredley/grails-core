...
* `cloud.wondrify.asset-pipeline` - The https://github.com/wondrify/asset-pipeline[asset pipeline] plugin enables the compilation of static assets (JavaScript, CSS etc.)
