...
The following SiteMesh 2-era configuration properties are no longer consulted and can be removed from your `application.yml` if present:

[source,yaml]
----
# Remove these — no longer used in Grails 7.2
