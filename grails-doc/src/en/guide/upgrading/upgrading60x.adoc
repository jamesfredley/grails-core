...
When upgrading to Grails {version}, ensure that your project is configured to use Java 17. Updating to Java 17 allows you to take advantage of the latest features, security enhancements, and performance improvements provided by Java 17.

Please make sure to update your project's Java version to 17 before proceeding with the Grails {version} upgrade.
...
When upgrading to Grails {version}, ensure that you update your build configuration to use the new group ID.
