...
===== 11.2 Removed libraries/classes
...
===== 11.3 Micronaut in Grails is now supported via the Micronaut Spring Boot Starter
...
===== 11.6 Removal of Test Dependencies from Production Classpath
...
===== 11.7 Jar Artifact name changes
