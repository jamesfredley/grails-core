...
3. **Consistency**: All temporal types (`Date`, `Calendar`, `Instant`, `LocalDateTime`) now render consistently, making it easier to handle dates uniformly across your application.
