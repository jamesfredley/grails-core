...
8. `org.grails.plugins.databinding.DataBindingGrailsPlugin`- use `DataBindingConfiguration` instead.
9. `grails.testing.gorm.DataTest#dataSource` - use `DataTest#datasource` instead.
