...
When you create a Grails application with the link:{commandLineRef}create-app.html[create-app] command by default the "web" profile is used:
...
To find out what profiles are available, use the link:{commandLineRef}list-profiles.html[list-profiles] command:
...
For more information on a particular profile, use the link:{commandLineRef}profile-info.html[profile-info] command:
