...
By default, Grails will resolve profiles from  https://repo.maven.org/maven2/org/apache/grails/profiles/[Maven central repository]. However, you can override what repositories will be searched by specifying repositories in the `USER_HOME/.grails/settings.groovy` file.
