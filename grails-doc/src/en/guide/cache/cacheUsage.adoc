...
time-to-live, maximum cache size, etc. Currently, the only extension plugin available for Grails 3 is https://github.com/grails-plugins/grails-cache-ehcache[cache-ehcache].
