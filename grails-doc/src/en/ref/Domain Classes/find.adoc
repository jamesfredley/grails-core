...
The `find` method allows querying with Hibernate's query language https://gorm.grails.org/{gormVersion}/hibernate/manual/index.html#hql[HQL] and querying by example. The basic syntax is:
