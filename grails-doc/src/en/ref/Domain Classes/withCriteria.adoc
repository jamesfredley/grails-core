...
The `withCriteria` method allows the inline definition of https://gorm.grails.org/{gormVersion}/hibernate/manual/index.html#criteria[Criteria]. Arguments to the [https://apache.github.io/grails-data-mapping/latest/api/grails/orm/HibernateCriteriaBuilder.html] can be passed as the first parameter:
