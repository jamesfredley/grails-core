...
* `useToken` (optional) - Set whether to send a token in the request to handle duplicate form submissions. See xref:../guide/theWebLayer/controllers/formtokens.adoc[Handling Duplicate Form Submissions]
