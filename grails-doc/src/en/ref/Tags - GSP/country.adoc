...
Uses the internal ISO3166_3 country code date that the xref:countrySelect.html[countrySelect] tag is based upon, to quickly render the name of a country given the code.
