...
You can turn on autowire for all your domain classes using the link:{hibernate5Guide}/manual/index.html#_the_default_mapping_constraints[Default Mapping] setting:
