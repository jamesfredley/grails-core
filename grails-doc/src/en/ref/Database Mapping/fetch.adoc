...
Note that excessive use of joins can be a performance bottleneck. See the section on https://gorm.grails.org/{gormVersion}/hibernate/manual/index.html#fetching[Eager vs Lazing Fetching] in the user guide.
