...
By default GORM is configured with  link:{hibernate5GuideFromRef}index.html#locking[optimistic locking] enabled. You can disable this by calling the `version` method with an argument of `false`:
