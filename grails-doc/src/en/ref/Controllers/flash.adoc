...
This pattern lets you use HTTP redirects (which is useful for https://www.theserverside.com/tt/articles/article.tss?l=RedirectAfterPost[redirect after post]) and retain values that can be retrieved from the flash object.
