...
A reference to the binding of the GSP that the tag library is being executed within. Allows access to variables set with the xref:../Tags%20-%20GSP/set.adoc[set] tag and those passed to the page from the controller model.
