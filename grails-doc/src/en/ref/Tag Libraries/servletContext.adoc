...
The xref:../ref/Servlet%20API/servletContext.adoc[servletContext] object is an instance of the Servlet API's {javaee}javax/servlet/ServletContext.html[ServletContext] class.
...
NOTE: Grails adds additional methods to the standard Servlet API's xref:../ref/Servlet%20API/servletContext.adoc[servletContext] object. See link for details.
