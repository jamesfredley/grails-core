...
NOTE: The additional methods added to the xref:../ref/Servlet%20API/response.adoc[response] object are documented in the Grails Servlet API reference guide
