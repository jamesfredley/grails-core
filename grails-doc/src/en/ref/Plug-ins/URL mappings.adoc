...
* `grailsUrlMappingsHolderBean` - A link:{apiFromRef}org/grails/web/mapping/UrlMappingsHolderFactoryBean.html[UrlMappingsHolderFactoryBean] factory bean that constructs a link:{apiFromRef}grails/web/mapping/UrlMappingsHolder.html[grails.web.mapping.UrlMappingsHolder] instance that stores all of the URL mappings.
