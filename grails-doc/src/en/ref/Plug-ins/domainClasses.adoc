...
Refer to the section on link:https://gorm.grails.org/{gormVersion}/hibernate/manual/[GORM] in the Grails user guide which details how to create Grails domain classes.
