...
* `BookServiceServiceClass` - The link:{apiFromRef}grails/core/GrailsServiceClass.html[GrailsServiceClass] instance which implements the conventions defined within a services class.
