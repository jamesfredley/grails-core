...
import grails.gorm.transactions.Transactional
    ...
    ''')
        ...
        mySpec.newInstance().'$tt__$spock_feature_0_0'(2,2,4,new DefaultTransactionStatus("test", new Object(), true, true, false, false, false, null))
    ...
    ''')
        ...
        and:"The spec can be called"
        mySpec.newInstance().'$tt__$spock_feature_0_0'(new DefaultTransactionStatus("test", new Object(), true, true, false, false, false, null))
