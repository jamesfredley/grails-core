...
* `BookServiceServiceClass` - The https://docs.grails.org/3.2.x/apiorg/codehaus/groovy/grails/commons/GrailsServiceClass.html[GrailsServiceClass] instance which implements the conventions defined within a services class.
