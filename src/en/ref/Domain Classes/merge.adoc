...
The `merge` method is equivalent to the Hibernate https://docs.jboss.org/hibernate/orm/current/javadocs/org/hibernate/Session#merge(java/lang/Object).html[merge] method.
