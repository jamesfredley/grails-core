...
Equivalent to the Hibernate https://javadoc.io/doc/org.hibernate/hibernate-core/{hibernateVersion}/org/hibernate/Session.html#refresh-java.lang.Object-[refresh] method.
