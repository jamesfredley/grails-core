...
_namedQueries are deprecated. Use https://gorm.grails.org/latest/hibernate/manual/index.html#whereQueries[where] queries instead._

=== Purpose


The `namedQueries` static property defines named queries.  Named queries support the criteria builder syntax.  See the section on the https://gorm.grails.org/6.0.x/hibernate/manual/index.html#criteria[Criteria Builder] in the user guide for more information.
