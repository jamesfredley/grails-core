...
Refer to the user guide section of https://gorm.grails.org/6.0.x/hibernate/manual/index.html#programmaticTransactions[Programmatic Transactions] for more information.
