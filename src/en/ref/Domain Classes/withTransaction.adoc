...
Refer to the user guide section of https://gorm.grails.org/{gormVersion}/hibernate/manual/index.html#programmaticTransactions[Programmatic Transactions] for more information.
