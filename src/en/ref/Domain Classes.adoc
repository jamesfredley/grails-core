...
You can turn on autowire for all your domain classes using the https://gorm.grails.org/latest/hibernate/manual/index.html#_the_default_mapping_constraints[Default Mapping] setting:
