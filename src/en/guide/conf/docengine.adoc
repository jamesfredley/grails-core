...
The documentation engine uses a variation on the https://txstyle.org/[Textile] syntax to automatically create project documentation with smart linking, formatting etc.
