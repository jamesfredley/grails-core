...
* https://gorm.grails.org[GORM] - An easy-to-use Object Mapping library with support for https://gorm.grails.org/latest/hibernate[SQL], http://gorm.grails.org/latest/mongodb[MongoDB], http://gorm.grails.org/latest/neo4j[Neo4j] and http://gorm.grails.org[more].
