...
* https://gorm.grails.org[GORM] - An easy-to-use Object Mapping library with support for https://gorm.grails.org/{gormVersion}/hibernate[SQL], https://gorm.grails.org/{gormVersion}/mongodb[MongoDB], https://gorm.grails.org/{gormVersion}/neo4j[Neo4j] and http://gorm.grails.org[more].
...
|https://gorm.grails.org/{gormVersion}/hibernate[GORM for Hibernate]
|An Object Mapping implementation for SQL databases

|https://gorm.grails.org/{gormVersion}/mongodb[GORM for MongoDB]
|An Object Mapping implementation for the MongoDB Document Database

|https://gorm.grails.org/{gormVersion}/neo4j[GORM for Neo4j]
