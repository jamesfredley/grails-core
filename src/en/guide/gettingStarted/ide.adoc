...
To improve speed in IntelliJ IDEA you can adjust the following settings under Help -> Custom VM Options.  If your machine has less RAM, you will need to adjust these down to slightly lower values.
